...
const MemoryAllocationDiagram: React.FC<MemoryAllocationDiagramProps> = ({ title }) => {
      ...
      nodes: [
        {
          ...
          position: { x: 100, y: 50 },
          style: { width: 180, height: 40, backgroundColor: '#f0f4f8', borderColor: '#cbd5e1' }
        },
        {
          id: '2',
          data: { label: 'x (not initialized)' },
          position: { x: 100, y: 150 },
          style: { width: 180, padding: '10px', backgroundColor: '#fef3c7', borderColor: '#fbbf24' }
        },
        {
          id: '3',
    ...
    },
    {
      ...
      nodes: [
        ...
        },
        {
          ...
          data: { label: 'x = 42' },
          position: { x: 100, y: 150 },
          style: { width: 180, padding: '10px', backgroundColor: '#dcfce7', borderColor: '#86efac' }
        },
        {
          id: '3',
          data: { label: 'Heap Memory' },
    ...
    },
    {
      ...
      nodes: [
        ...
        },
        {
          ...
          style: { width: 180, padding: '10px', backgroundColor: '#dbeafe', borderColor: '#93c5fd' }
        },
        {
          id: '5',
  ...
  const [nodes, , onNodesChange] = useNodesState(steps[step].nodes);
  const [edges, , onEdgesChange] = useEdgesState(steps[step].edges);
